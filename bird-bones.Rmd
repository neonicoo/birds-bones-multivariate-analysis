...
```{r bca tab}
bcatab <- bca.birds$tab ; bcatab[, 1:6]
```
...
```{r meantab}
meantab <-  aggregate(birds2[,1:10], list(birds2$groups), mean); meantab[, 1:6]
```
...
```{r dendrogram }
dbirds <- round(dist(bca.birds$tab), 3)
