...
## 5. Clustering & dendrograms:


```{r clustering }
clusty_bet <- hclust(dist(bcatab) , "complete")
clusty_discrim <- hclust( dist(ldatab) , "complete")
clusty_var <- hclust(dist(t(birds2[,-11])) , "complete")
clusty_indv <- hclust(dist(birds2[1:10]) , "complete")
```
...
# Interprétation(s) et conclusion :
